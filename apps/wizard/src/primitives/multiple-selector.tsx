    ...
    (
        ...
        return (
            ...
            >
                <div
                    className={cn(
                        'min-h-8 rounded-md shadow border border-input text-sm ring-offset-background focus-within:ring-1 focus-within:ring-ring cursor-pointer relative',
                        {
                ...
                >
                    {selected.length === 0 && <CaretSortIcon className='h-4 w-4 opacity-50 absolute right-2 bottom-2 z-1' />}
