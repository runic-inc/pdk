...
contract AccountPatchTest is Test {
    ...
    function setUp() public {
        ...
        _myContract = new AccountPatch(address(_prot), _scopeOwner);
    ...
    function testSupportsInterface() public {
        ...
        assertTrue(_myContract.supportsInterface(type(IPatchworkAccountPatch).interfaceId));
    }
    ...
    function testPackUnpackMetadata() public {
        AccountPatch.Metadata memory originalData;
        ...
        AccountPatch.Metadata memory unpackedData = _myContract.unpackMetadata(packed);
    ...
    function testName() public {
        vm.startPrank(_scopeOwner);
        uint256 tokenId = _myContract.mintPatch(_userAddress, _userAddress);
