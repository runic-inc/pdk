...
contract MyDynRef is DynRef {
    uint256 _nextTokenId;

    constructor(address _manager, address _owner) DynRef(_manager, _owner) {}
...
contract DynRefTest is Test {
    PatchworkProtocol _prot;
    MyDynRef _myContract;
    ...
    function setUp() public {
        ...
        _myContract = new MyDynRef(address(_prot), _scopeOwner);
        vm.stopPrank();
    }
    ...
    function testSchema() public {
        ...
        assertEq(uint(entry.fieldType), uint(IPatchworkMetadata.FieldType.CHAR32));
    ...
    function testPackUnpackMetadata() public {
        DynRef.Metadata memory originalData;
        ...
        DynRef.Metadata memory unpackedData = _myContract.unpackMetadata(packed);
