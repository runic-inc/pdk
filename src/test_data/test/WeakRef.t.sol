...
contract MyWeakRef is WeakRef {
    uint256 _nextTokenId;

    constructor(address _manager, address _owner) WeakRef(_manager, _owner) {}
...
contract WeakRefTest is Test {
    PatchworkProtocol _prot;
    MyWeakRef _myContract;
    ...
    function setUp() public {
        ...
        _myContract = new MyWeakRef(address(_prot), _scopeOwner);
    ...
    function testPackUnpackMetadata() public {
        WeakRef.Metadata memory originalData;
        ...
        WeakRef.Metadata memory unpackedData = _myContract.unpackMetadata(packed);
