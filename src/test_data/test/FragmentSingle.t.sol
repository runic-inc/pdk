...
contract MyFragmentSingle is FragmentSingle {
    uint256 _nextTokenId;

    constructor(address _manager, address _owner) FragmentSingle(_manager, _owner) {}
...
contract FragmentSingleTest is Test {
    PatchworkProtocol _prot;
    MyFragmentSingle _myContract;
    ...
    function setUp() public {
        ...
        _myContract = new MyFragmentSingle(address(_prot), _scopeOwner);
    ...
    function testPackUnpackMetadata() public {
        FragmentSingle.Metadata memory originalData;
        ...
        FragmentSingle.Metadata memory unpackedData = _myContract.unpackMetadata(packed);
