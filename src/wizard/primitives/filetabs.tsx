...
const TabsTrigger = React.forwardRef<React.ElementRef<typeof TabsPrimitive.Trigger>, React.ComponentPropsWithoutRef<typeof TabsPrimitive.Trigger>>(
    ({ className, ...props }, ref) => (
        <TabsPrimitive.Trigger
            ref={ref}
            className={cn(
                'inline-flex items-center dotted justify-center rounded-t whitespace-nowrap px-6 py-3 text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 border border-muted-foreground border-b-border data-[state=active]:text-foreground data-[state=active]:!border-b-transparent mr-1 data-[state=active]:border-border bg-muted data-[state=active]:bg-background data-[state=active]:bg-none',
                className,
            )}
            {...props}
        />
