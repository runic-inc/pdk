...
import "./FragmentMultiGenerated.sol";

contract FragmentMulti is FragmentMultiGenerated {
    constructor(address _manager, address _owner) FragmentMultiGenerated(_manager, _owner) {}
