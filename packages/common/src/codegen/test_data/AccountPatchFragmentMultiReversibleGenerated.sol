...
abstract contract AccountPatchFragmentMultiReversibleGenerated is PatchworkReversibleAccountPatch, PatchworkFragmentMulti {
    ...
    constructor(address _manager, address _owner)
        Patchwork721("test", "AccountPatchFragmentMultiReversible", "TST", _manager, _owner)
    {}
    ...
    function supportsInterface(bytes4 interfaceID) public view virtual override(PatchworkFragmentMulti, PatchworkReversibleAccountPatch) returns (bool) {
        return PatchworkFragmentMulti.supportsInterface(interfaceID) ||
            PatchworkReversibleAccountPatch.supportsInterface(interfaceID);
    }
