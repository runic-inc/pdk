...
abstract contract AccountPatchFragmentSingleGenerated is PatchworkAccountPatch, PatchworkFragmentSingle {
    ...
    constructor(address _manager, address _owner)
        Patchwork721("test", "AccountPatchFragmentSingle", "TST", _manager, _owner)
    {}
    ...
    function supportsInterface(bytes4 interfaceID) public view virtual override(PatchworkFragmentSingle, PatchworkAccountPatch) returns (bool) {
