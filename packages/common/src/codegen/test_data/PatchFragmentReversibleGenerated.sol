...
abstract contract PatchFragmentReversibleGenerated is PatchworkReversiblePatch, PatchworkFragmentSingle {
    ...
    constructor(address _manager, address _owner)
        Patchwork721("test", "PatchFragmentReversible", "PFRAG", _manager, _owner)
    {}
    ...
    function supportsInterface(bytes4 interfaceID) public view virtual override(PatchworkFragmentSingle, PatchworkReversiblePatch) returns (bool) {
    ...
    function updateOwnership(uint256 tokenId) public virtual override(PatchworkPatch, IPatchworkPatch, PatchworkFragmentSingle) {
