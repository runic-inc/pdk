import { GeneratorService as GenService } from '../../services/generator';
...
export async function localDevUp(configPath: string, config: DeployConfig = {}, genService: GenService): Promise<DeploymentAddresses> {
